...
const Sidebar = () => {
    ...
    return (
        <div>
            ...
            <a className="flex items-center justify-center px-2 py-1 my-3 bg-gray-200 rounded-full dark:bg-dark-200" href="/assets/siddhesh_bgk_2024.pdf" download="siddhesh_bgk_2024.pdf">
                <GiTie className="w-6 h-6" /> Download Resume
            </a>
            <div className="flex justify-around w-9/12 mx-auto my-5 text-green md:w-full">
                <a href="https://www.linkedin.com/in/sid-bgk" target="_blank" rel="noreferrer" aria-label="LinkedIn">
            ...
            <div className="py-4 my-5 bg-gray-200 dark:bg-dark-200" style={{ marginLeft: '-1rem', marginRight: '-1rem' }}>
                ...
                <p className="my-2">siddhesh.bgk01@gmail.com</p>
                <p className="my-2">+91 814 999 1128</p>
            </div>
            <button className="w-8/12 px-5 py-2 my-2 text-white rounded-full bg-gradient-to-r from-green to-blue-400 focus:outline-none"
                onClick={() => window.open("mailto:siddhesh.bgk01@gmail.com")}
            >Email me</button>
